...
public class BookingDtoTest {
    ...
    void testUserDto() throws Exception {
        ...
        assertThat(result).extractingJsonPathStringValue("$.start").isEqualTo("2002-07-03 12:00");
        assertThat(result).extractingJsonPathStringValue("$.end").isEqualTo("2002-07-03 13:00");
