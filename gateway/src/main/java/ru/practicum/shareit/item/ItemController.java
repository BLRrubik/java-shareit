...
public class ItemController {
    ...
    public Object createItem(@RequestBody @Valid ItemCreateRequest request,
                             @RequestHeader("X-Sharer-User-Id") @Positive Long userPrincipal) {
        log.info("Creating items " + request.toString() + " by user with id " + userPrincipal);

        return itemClient.createItem(request, userPrincipal);
    }
    ...
    public Object updateItem(@RequestBody @Valid ItemUpdateRequest request,
        ...
        return itemClient.updateItem(request, itemId, userPrincipal);
    }
